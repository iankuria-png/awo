...
def scoring():
    ...
    main = f'''<div style="display: grid; grid-template-columns: minmax(0, 1fr) 340px; gap: 20px; align-items: start">
      <div style="display: flex; flex-direction: column; gap: 16px">
        ...
        <section class="pn" style="padding: 6px 18px 4px; overflow: hidden"><div class="th" style="display: grid; grid-template-columns: minmax(0, 1.6fr) 1fr 1fr; gap: 12px; padding: 10px 0">Stage<span>Readiness in v1.3</span><span>Readiness in v1.4</span></div>{brows}</section>
