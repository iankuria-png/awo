...
**Current focus:** Round 8 batch 1 is on page `r8` ([14](00-discovery/14-round-8.md)): the research, a ranked Hub shortlist and the Hub's icon in three directions. Ian picks the icon (T-088), then batches 2 to 4 (T-089 to T-091)
...
2. **[TASKS.md](TASKS.md):** Ian picks the Hub's icon (T-088); Round 8 batches 2 to 4 follow (T-089 to T-091). Ian's Round 7 reactions (T-075, T-085) are still open.
...
- **Decisions:** D-001 to D-038 in [decisions/log.md](decisions/log.md). **Open questions:** [05-open-questions.md](00-discovery/05-open-questions.md) (non-blocking; newest are Q-34 to Q-41).
