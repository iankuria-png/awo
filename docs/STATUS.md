...
0. **[15-round-9.md](00-discovery/15-round-9.md):** Round 9 as it is built, batch by batch. Before it, **[14-round-8.md](00-discovery/14-round-8.md):** Round 8 as it's built: research, the ranked Hub shortlist, the new IA, the safe versions and the Hub's icon. The brief behind it is [handover/2026-09-25-round-8-kickoff.md](handover/2026-09-25-round-8-kickoff.md).
...
2. **[TASKS.md](TASKS.md):** Ian reacts to Round 8 (T-093) and decides whether briefs may name real companies (T-095, Q-36); what's left of Round 8 is T-094. Ian's Round 7 reactions (T-075, T-085) and the facts owner (T-092, Q-41) are still open.
...
- **Design canvas:** [AWO Direction Explorations](https://claude.ai/artifact/KxjTM3X7VQiEButw4QNiV9), pages Round 1 to Round 9 (opens on Round 9). Round 7 is the reference board, and holds every Round 8 board too, grouped by topic in 14 sections (onboarding, Home, Learn, the Hub, Community, Me, Admin, marketing and more).
...
- **Decisions:** D-001 to D-041 in [decisions/log.md](decisions/log.md). **Open questions:** [05-open-questions.md](00-discovery/05-open-questions.md) (non-blocking; newest are Q-34 to Q-46).
