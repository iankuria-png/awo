...
1. **[Handover for Round 3](handover/2026-09-24-round-3.md):** full context from session 1, covering taste, mistakes, the brief, gotchas, tokens and a kickoff prompt.
2. **[TASKS.md](TASKS.md):** what to do now (T-010 to T-018) and what's waiting on Ian.
