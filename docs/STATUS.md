...
**Current focus:** Round 8 is complete on page `r8` ([14](00-discovery/14-round-8.md)): the keystone Hub in lime (D-039), Learn with Paths, Words and Stories, nine Hub tools, goals, Home, the podcast and the Community feed. Ian reacts (T-093)
...
2. **[TASKS.md](TASKS.md):** Ian reacts to Round 8 (T-093); what's left of Round 8 is T-094. Ian's Round 7 reactions (T-075, T-085) and the facts owner (T-092, Q-41) are still open.
