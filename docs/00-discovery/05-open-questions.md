...
| Q-44 | **The DIVA score's name:** the marketing says "DIVA score" (Ian's words), while the app shows "Your DIVA profile" with "Readiness 63". One name for the number, everywhere? | Two names for one number confuse members, and the store screenshots show the app. | "DIVA score" for the 0 to 100 number in the app and the marketing; "DIVA profile" for the whole picture (score, stage, areas, evidence). Always paired with "not a credit score". | Decided: "DIVA score" everywhere (D-040) |
| Q-45 | **A savings-group (stokvel or chama) record book:** may AWO help a member keep her own group's records: who paid, whose turn, the payout order? | CLAUDE.md rules out capital pooling. A record book sits close to it, even though AWO would never hold, move or promise money. | Records only, kept by the member for her own group: contributions she marks as received, the payout order, reminders. AWO never holds, moves or guarantees money, never invites strangers, and says so on every screen. | Open (Round 9, batch 2) |
| Q-46 | **Sharing outside AWO:** what may a member share to WhatsApp or elsewhere? | Shared images travel beyond AWO's control, and a score or stage could be read as creditworthiness. | Milestones about showing up and learning, the word of the week and published stories; never amounts, the DIVA score or the stage. Her first name only if she chooses. | Open (Round 9, `R9-Milestone`, `R9-Status-*`) |
